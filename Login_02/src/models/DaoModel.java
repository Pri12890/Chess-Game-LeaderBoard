...
public class DaoModel {
	...
	public void createTable() {
		...
		try {
			...
			String sql = "CREATE TABLE IF NOT EXISTS leaderboard_tab1  " + "( userid INTEGER NOT NULL AUTO_INCREMENT , "
					+ " password VARCHAR(10), " + " username VARCHAR(15), " + " decription VARCHAR(100), "
					+ " score numeric(8,2), " + " wins numeric(8,2), " + " losses numeric(8,2), " + " image LONGBLOB, "
					+ " PRIMARY KEY ( userid ))";
	...
	/*
	 * public void insertRecords(BankRecords[] robjs) { try { // Execute a query
	 * System.out.println("Inserting records into the table..."); stmt =
	 * conn.connect().createStatement(); // Include all object data to the database
	 * table for (int i = 0; i < robjs.length; ++i) { // finish string assignment to
	 * insert all object data // (pid, id, income, pep) into your database table
